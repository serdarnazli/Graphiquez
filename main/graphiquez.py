...
class FileHandler():
    ...
    def read_xlsx(self, filename, row=None, column=None):
        ...
        if row == None and column != None:
            ...
            raise ValueError(
                "without row or column and with both row and column, read_xls'x function can not be called.")
    ...
    def amateur_main(self):
        ...
        while True:
            if sayac == 0:
                ...
                proc = input(
                    "Do you want to continue to make graphs or you wish to go back?\n0->Continue\n1->Go back").strip()
                if proc == "0":
                    pass
                else:
                    break
        ...
        if process == "2":
            while True:
                ...
                if function == "q":
                    ...
                    for i in function:
                        if i not in ["(", ")", "*", "-", "+", "/", "x", "1", "2", "3", "4", "5", "6", "7", "8", "9",
                                     "0"]:
                    ...
                    if plotorscatter == "1":
                        ...
                        ax.scatter(xaxis, yaxis, color=color)
                        ax.grid()
                        fig.show()
        ...
        if process == "3":
            ...
            while True:
                ...
                if function == "q":
                    return
                for i in function:
                    if i not in ["(", ")", "*", "-", "+", "/", "x", "y", "1", "2", "3", "4", "5", "6", "7", "8", "9",
                                 "0"]:
